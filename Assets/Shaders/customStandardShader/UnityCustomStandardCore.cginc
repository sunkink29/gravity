#ifndef UNITY_Custom_STANDARD_CORE_INCLUDED
#define UNITY_Custom_STANDARD_CORE_INCLUDED
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
	...
	c.rgb += Emission(i.tex.xy,s.normalWorld);
...
)
{
	...
	#ifdef _EMISSION
		color += Emission (i.tex.xy, s.normalWorld);
	#endif
